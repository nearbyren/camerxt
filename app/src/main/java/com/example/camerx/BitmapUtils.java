...
public class BitmapUtils {
    ...
    /**
     * 将来自 CameraX API 的 YUV_420_888 图像转换为Bitmap。  @ExperimentalGetImage
     */
    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    @Nullable
    public static Bitmap getBitmap(ImageProxy imageProxy,int rotationDegrees) {
        ...
        return getBitmap(nv21Buffer, imageProxy.getWidth(), imageProxy.getHeight(), rotationDegrees);//imageProxy.getImageInfo().getRotationDegrees()
    }
